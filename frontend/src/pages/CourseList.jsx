...
export default function CourseList() {
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="bg-white rounded-2xl shadow-md p-6 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            You need an EduNex account to browse and enroll in courses.
          </p>
          <button
            onClick={() => navigate("/")}
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-100 text-indigo-700 text-lg">
              📚
            </span>
            <div>
              ...
              <p className="text-sm text-gray-600">
                Find the right course to continue your learning journey on
                EduNex.
              </p>
            </div>
          </div>
      ...
      {/* Filters */}
      <div className="bg-white rounded-xl shadow-sm p-4 flex flex-col md:flex-row gap-3 items-end border border-gray-100">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <button
            ...
            className="flex-1 md:flex-none px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700 shadow-sm"
          >
            Apply
          </button>
          <button
            onClick={handleClearFilters}
            className="flex-1 md:flex-none px-4 py-2 rounded-lg border border-gray-300 text-sm text-gray-700 hover:bg-gray-100"
          >
            Clear
          </button>
        </div>
        ...
        <div className="py-10">
          <div className="bg-white rounded-xl shadow-sm p-6 text-center">
            <p className="text-gray-600 text-sm">
              No courses match your filters right now. Try clearing filters or
              checking back later.
            </p>
          </div>
        </div>
          ...
          {courses.map((course) => {
            ...
            return (
              ...
              >
                ...
                <div className="border-t bg-gray-50 px-4 py-3 flex items-center justify-between gap-3 rounded-b-xl">
